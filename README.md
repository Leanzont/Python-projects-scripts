...
| [port_scanner](./port_scanner/)             | TCP port scanner that exports results to JSON. No external dependencies.        | Networking, Sockets, CLI, JSON, argparse |
...
Self-taught developer based in Cochabamba, Bolivia, building skills in Cloud Engineering, DevOps,
AWS, Python automation, Linux, and Networking.
